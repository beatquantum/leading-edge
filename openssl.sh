...
openssl version
echo "*******************************************************************"
echo "* Updating to OpenSSL version 1.1.1n                              *"
...
sudo wget https://www.openssl.org/source/openssl-1.1.1n.tar.gz --no-check-certificate > /dev/null
sudo tar -zxf openssl-1.1.1n.tar.gz > /dev/null
cd openssl-1.1.1n > /dev/null
