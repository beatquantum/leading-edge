...
openssl version
echo "*******************************************************************"
echo "* Updating to OpenSSL version 3.0.8 for Debian 11 / Ubuntu 22     *"
...
sudo wget https://www.openssl.org/source/openssl-3.0.8.tar.gz --no-check-certificate > /dev/null
sudo tar -zxf openssl-3.0.8.tar.gz > /dev/null
cd openssl-3.0.8 > /dev/null
