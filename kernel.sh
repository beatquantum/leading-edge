...
uname -a
echo "*******************************************************************"
echo "* Updating to Linux kernel version (1) 5.13.RC2 OR (2) 5.12.12    *"
...
cd /tmp > /dev/null
echo "* Step 1 : Downloading Linux kernel files...                      *"
wget -c --no-check-certificate https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.12.12/amd64/linux-headers-5.12.12-051212-generic_5.12.12-051212.202106180931_amd64.deb
wget -c --no-check-certificate https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.12.12/amd64/linux-headers-5.12.12-051212_5.12.12-051212.202106180931_all.deb
wget -c --no-check-certificate https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.12.12/amd64/linux-image-unsigned-5.12.12-051212-generic_5.12.12-051212.202106180931_amd64.deb
wget -c --no-check-certificate https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.12.12/amd64/linux-modules-5.12.12-051212-generic_5.12.12-051212.202106180931_amd64.deb
echo "* Step 2 : Updating Linux kernel 5.12.12        ...(patience!)    *"
dpkg -i *.deb
echo "* Linux kernel has been updated.                                  *"
echo "* Reboot at your convenience and check the kernel using uname -a  *"
echo "*******************************************************************"
