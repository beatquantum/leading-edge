...
uname -a
echo "*******************************************************************"
echo "* Updating to Linux kernel version (1) 5.11.6 OR (2) 5.10.16   *"
...
wget -c --no-check-certificate https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.11.6/amd64/linux-headers-5.11.6-051106-generic_5.11.6-051106.202103111435_amd64.deb
wget -c --no-check-certificate https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.11.6/amd64/linux-headers-5.11.6-051106_5.11.6-051106.202103111435_all.deb
wget -c --no-check-certificate https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.11.6/amd64/linux-image-unsigned-5.11.6-051106-generic_5.11.6-051106.202103111435_amd64.deb
wget -c --no-check-certificate https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.11.6/amd64/linux-modules-5.11.6-051106-generic_5.11.6-051106.202103111435_amd64.deb
echo "* Step 2 : Updating Linux kernel 5.11.6   (patience!)             *"
dpkg -i *.deb
